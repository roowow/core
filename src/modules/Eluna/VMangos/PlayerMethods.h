...
//     }
    ...
    /**
     * Returns 'true' if the [Player] is Hardcore.
     *
     * @return bool IsHardcore
     */
    int IsHardcore(lua_State* L, Player* player)
    {
        Eluna::Push(L, player->IsHardcore());
        return 1;
    }
    ...
    /**
     * Returns 'true' if the [Player] is Hardcore PVP.
     *
     * @return bool IsHardcore
     */
    int IsHardcorePVP(lua_State* L, Player* player)
    {
        Eluna::Push(L, player->IsHardcorePVP());
        return 1;
    }
    ...
    /**
     * Set Hardcore Retired
     */
    int SetHardcoreRetired(lua_State* L, Player* player)
    {
     ...
     * Set Hardcore PVP
     */
    int SetHardcorePVP(lua_State* L, Player* player)
    {
        bool apply = Eluna::CHECKVAL<bool>(L, 2, true);
     ...
     * Returns Honor Rank
     */
    int GetHonorRank(lua_State* L, Player* player)
    {
        Eluna::Push(L, player->GetHonorMgr().GetRank().rank);
        return 1;
    }

    /**
     * Returns [Player] active talent.
     */
    int ActiveTalent(lua_State* L, Player* player)
    {
        Eluna::Push(L, player->ActiveTalent());
        return 1;
    }
     ...
     * Set Active Talent
     */
    int SetActiveTalent(lua_State* L, Player* player)
    {
        uint32 talent = Eluna::CHECKVAL<uint32>(L, 2, true);
    ...
    ElunaRegister<Player> PlayerMethods[] =
    {
        ...
        { "SetHardcore", &LuaPlayer::SetHardcore }, /// Hardcore
        { "SetHardcoreRetired", &LuaPlayer::SetHardcoreRetired }, /// Hardcore
        { "SetHardcoreDead", &LuaPlayer::SetHardcoreDead }, /// Hardcore
        { "SetHardcorePVP", &LuaPlayer::SetHardcorePVP }, /// Hardcore
#if defined(CLASSIC)
