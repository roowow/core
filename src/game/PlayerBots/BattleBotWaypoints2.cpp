...
// Alliance base straight to Blacksmith — GM-recorded 2026-09-04 (see ABLogic.md 8.23) to
// give bots a direct route instead of always hopping via an intermediate node whose flag
// (and the enemy converging on it) swallows them before they ever continue on.
BattleBotPath vPath_AB_AllianceBase_to_Blacksmith =
{
    { 1283.3428f, 1281.2158f, -16.4912f, nullptr },
    { 1276.5908f, 1269.1838f, -20.3218f, nullptr },
    { 1271.4523f, 1260.0271f, -24.1553f, nullptr },
    { 1266.3138f, 1250.8704f, -27.5827f, nullptr },
    { 1261.1753f, 1241.7136f, -31.3266f, nullptr },
    { 1256.0369f, 1232.5569f, -34.4348f, nullptr },
    { 1250.8983f, 1223.4001f, -39.8034f, nullptr },
    { 1245.7599f, 1214.2434f, -42.9570f, nullptr },
    { 1240.7716f, 1205.0042f, -44.5784f, nullptr },
    { 1235.8536f, 1195.7272f, -47.1787f, nullptr },
    { 1230.9688f, 1186.4326f, -50.5607f, nullptr },
    { 1226.0839f, 1177.1381f, -53.1755f, nullptr },
    { 1221.1990f, 1167.8436f, -54.8191f, nullptr },
    { 1216.2765f, 1158.5690f, -55.4779f, nullptr },
    { 1211.2983f, 1149.3241f, -56.0668f, nullptr },
    { 1206.3888f, 1140.0463f, -55.8671f, nullptr },
    { 1201.6724f, 1130.6654f, -57.1825f, nullptr },
    { 1197.0819f, 1121.2220f, -58.8655f, nullptr },
    { 1192.4913f, 1111.7787f, -61.2218f, nullptr },
    { 1188.1141f, 1102.2384f, -62.8327f, nullptr },
    { 1184.2283f, 1092.4843f, -63.0376f, nullptr },
    { 1180.6108f, 1082.6276f, -63.8610f, nullptr },
    { 1177.4592f, 1072.6127f, -64.4168f, nullptr },
    { 1174.4025f, 1062.5674f, -64.7896f, nullptr },
    { 1171.3457f, 1052.5222f, -65.0359f, nullptr },
    { 1168.2692f, 1042.4830f, -65.4011f, nullptr },
    { 1165.1089f, 1032.4702f, -65.0493f, nullptr },
    { 1162.6461f, 1026.0410f, -64.7041f, nullptr },
    { 1158.2296f, 1016.8710f, -63.6042f, nullptr },
    { 1159.1135f, 1009.3955f, -63.9354f, nullptr },
    { 1158.2710f, 1003.5954f, -63.9454f, nullptr },
    { 1149.0780f, 1001.4672f, -63.7265f, nullptr },
    { 1138.5819f, 1001.4932f, -62.8299f, nullptr },
    { 1128.0851f, 1001.7317f, -60.7902f, nullptr },
    { 1117.5859f, 1001.8645f, -60.6143f, nullptr },
    { 1111.6951f, 1002.1627f, -61.5564f, nullptr },
    { 1101.3241f, 1003.7957f, -61.0241f, nullptr },
    { 1090.9785f, 1005.5466f, -59.7123f, nullptr },
    { 1080.6294f, 1007.3202f, -57.4499f, nullptr },
    { 1070.2811f, 1009.0989f, -54.1393f, nullptr },
    { 1060.0270f, 1011.3456f, -50.7813f, nullptr },
    { 1052.1533f, 1010.6642f, -49.0254f, nullptr },
    { 1043.1176f, 1013.6311f, -47.2120f, nullptr },
    { 1031.0380f, 1016.3566f, -45.5345f, nullptr },
    { 1025.1219f, 1020.4454f, -44.9975f, nullptr },
    { 1017.1094f, 1027.2312f, -44.2581f, nullptr },
    { 1010.9787f, 1032.1659f, -43.7661f, nullptr },
    { 1005.1400f, 1035.8550f, -43.2272f, nullptr },
    { 990.9822f, 1041.9330f, -42.7639f, nullptr },
    { 979.2176f, 1046.0757f, -44.5693f, &AB_AtFlag },
};

// Horde base straight to Blacksmith — GM-recorded 2026-09-04, same reasoning as the
// Alliance route above.
BattleBotPath vPath_AB_HordeBase_to_Blacksmith =
{
    { 705.9844f, 707.7192f, -17.2050f, nullptr },
    { 711.2803f, 712.6278f, -19.8440f, nullptr },
    { 718.2365f, 720.4929f, -24.7787f, nullptr },
    { 725.1180f, 728.4232f, -29.4653f, nullptr },
    { 731.5983f, 736.6835f, -33.6502f, nullptr },
    { 737.9537f, 745.0400f, -37.1872f, nullptr },
    { 744.6805f, 753.1022f, -39.7462f, nullptr },
    { 748.2557f, 758.1965f, -41.2840f, nullptr },
    { 750.5170f, 763.2792f, -42.3816f, nullptr },
    { 752.3399f, 768.5563f, -43.2829f, nullptr },
    { 754.8159f, 778.7596f, -45.4567f, nullptr },
    { 757.1691f, 788.9921f, -46.8337f, nullptr },
    { 759.2921f, 799.2751f, -47.7481f, nullptr },
    { 760.9609f, 809.6401f, -48.7177f, nullptr },
    { 762.3985f, 820.0411f, -49.6177f, nullptr },
    { 764.0120f, 828.4114f, -50.1601f, nullptr },
    { 767.4454f, 838.3315f, -50.7889f, nullptr },
    { 771.7041f, 847.9263f, -51.9508f, nullptr },
    { 776.2770f, 857.3777f, -53.4233f, nullptr },
    { 780.9311f, 866.7900f, -54.2800f, nullptr },
    { 785.6072f, 876.1912f, -55.3246f, nullptr },
    { 790.3086f, 885.5798f, -56.1448f, nullptr },
    { 795.0100f, 894.9685f, -56.5739f, nullptr },
    { 799.7115f, 904.3571f, -56.9255f, nullptr },
    { 804.6812f, 913.6003f, -56.8932f, nullptr },
    { 810.2791f, 922.4836f, -56.9506f, nullptr },
    { 815.9388f, 931.3273f, -57.4232f, nullptr },
    { 821.9097f, 939.9641f, -58.1219f, nullptr },
    { 828.4771f, 948.1532f, -59.4070f, nullptr },
    { 837.3505f, 958.6907f, -60.6009f, nullptr },
    { 844.3322f, 966.5284f, -60.8278f, nullptr },
    { 851.9501f, 973.7462f, -61.0959f, nullptr },
    { 862.6268f, 981.9233f, -62.4217f, nullptr },
    { 874.1165f, 986.7278f, -61.8536f, nullptr },
    { 882.6678f, 988.9576f, -61.5778f, nullptr },
    { 894.2287f, 991.4006f, -63.5416f, nullptr },
    { 903.9448f, 995.3788f, -62.4236f, nullptr },
    { 913.9183f, 998.5886f, -58.4250f, nullptr },
    { 924.0013f, 1001.5085f, -55.3168f, nullptr },
    { 934.2923f, 1003.5920f, -51.8909f, nullptr },
    { 943.9510f, 1006.6856f, -49.0006f, nullptr },
    { 949.8569f, 1009.5638f, -47.6020f, nullptr },
    { 954.6133f, 1012.4484f, -46.6776f, nullptr },
    { 963.7637f, 1020.4291f, -45.2886f, nullptr },
    { 970.1064f, 1028.3660f, -44.1483f, nullptr },
    { 974.6580f, 1035.9525f, -43.6222f, nullptr },
    { 977.1378f, 1041.3071f, -44.2940f, &AB_AtFlag },
};
...
std::vector<BattleBotPath*> const vPaths_AB =
{
    ...
    &vPath_AB_AllianceBase_to_Blacksmith,
    &vPath_AB_HordeBase_to_Blacksmith,
};
