...
enum eConfigUInt32Values
{
    ...
    CONFIG_UINT32_AV_MAX_CONCURRENT_INSTANCES,
    ...
    CONFIG_UINT32_BATTLE_ROYALE_MIN_PLAYERS,
    CONFIG_UINT32_BATTLE_ROYALE_COUNTDOWN_SEC,
...
enum eConfigBoolValues
{
    ...
    CONFIG_BOOL_BATTLE_ROYALE_MOVEMENT_DEBUG,
    CONFIG_BOOL_BATTLEGROUND_MOVEMENT_DEBUG,
